...
const exampleFoundContents = `
{
  ...
  "scripts": {
    ...
    "deploy:release": "npm run build && sls deploy -v -s $DEPLOYMENT_ENV",
    ...
    "deploy:dev": "DEPLOYMENT_ENV=dev npm run deploy:release",
    "deploy:prod": "DEPLOYMENT_ENV=prod npm run deploy:release && npm run deploy:send-notification",
