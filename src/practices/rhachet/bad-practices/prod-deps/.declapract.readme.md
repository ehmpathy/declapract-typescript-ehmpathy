...
detects `rhachet` and every `rhachet-<family>-*` package (e.g. `rhachet-roles-*`, `rhachet-brains-*`) listed as production dependencies and moves them to devDependencies.
...
- `rhachet`
- `rhachet-<family>-*` — every rhachet family, e.g.
  - `rhachet-roles-*` (`rhachet-roles-ehmpathy`, `rhachet-roles-bhrain`, `rhachet-roles-bhuild`)
  - `rhachet-brains-*`

a single-segment `rhachet-*` (e.g. `rhachet-other`, no family segment) is left alone.
